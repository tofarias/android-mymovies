...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO "+ DbOpenHelper.MOVIE_TABLE+" ('title_en', 'title_pt_br', 'category_id','comment', 'release_year', 'watched_where_id') VALUES ('Lethal Weapon 1', 'Máquina Mortifera 1', 6,'Após a morte de sua esposa, o detetive da polícia de Los Angeles, Martin Riggs, torna-se temerário e suicida. O detetive é transferido e imediatamente entra em choque com o novo parceiro, Roger Murtaugh, o mais antigo funcionário do departamento. Juntos, eles descobrem um cartel do tráfico de drogas. As situações cada vez mais perigosas formam um vínculo entre os dois.', '1987', 5)");
        db.execSQL("INSERT INTO "+ DbOpenHelper.MOVIE_TABLE+" ('title_en', 'title_pt_br', 'category_id','comment', 'release_year', 'watched_where_id') VALUES ('Die Hard 1', 'Duro de Matar 1', 5,'O policial de Nova York John McClane está visitando sua família no Natal. Ele participa de uma confraternização de fim de ano na sede da empresa japonesa em que a esposa trabalha. A festa é interrompida por terroristas que invadem o edifício de luxo. McClane não demora a perceber que não há ninguém para salvá-los, a não ser ele próprio.', '1988', 4)");
        db.execSQL("INSERT INTO "+ DbOpenHelper.MOVIE_TABLE+" ('title_en', 'title_pt_br', 'category_id','comment', 'release_year', 'watched_where_id') VALUES ('The Blair Witch Project', 'A Bruxa de Blair', 4,'Um grupo de três jovens cineastas desaparece ao entrar em uma floresta de Maryland para gravar um documentário sobre uma lenda local conhecida como A Bruxa de Blair. Anos depois, a câmera que usavam é encontrada.', '1999', 3)");
        db.execSQL("INSERT INTO "+ DbOpenHelper.MOVIE_TABLE+" ('title_en', 'title_pt_br', 'category_id','comment', 'release_year', 'watched_where_id') VALUES ('Horrible Bosses 1', 'Quero Matar Meu Chefe 1', 3,'Três amigos têm um problema em comum: eles odeiam seus chefes exploradores. Assim, bolam um plano. Já que não podem pedir demissão, contratam um consultor que os ajudará a matar os chefes.', '2011', 2)");
        db.execSQL("INSERT INTO "+ DbOpenHelper.MOVIE_TABLE+" ('title_en', 'title_pt_br', 'category_id','comment', 'release_year', 'watched_where_id') VALUES ('Braveheart', 'Coracao Valente', 2,'A história de um herói escocês do século 13, chamado William Wallace, que lidera seus conterrâneos contra o monarca inglês Edward I, após ter sofrido uma tragédia pessoal causada pelos soldados ingleses. O exército amador de Wallace foi maior que o exército da Inglaterra.', '1995', 2)");
        db.execSQL("INSERT INTO "+ DbOpenHelper.MOVIE_TABLE+" ('title_en', 'title_pt_br', 'category_id','comment', 'release_year', 'watched_where_id') VALUES ('The Green Mile', 'A Espera de Um Milagre', 1, 'Um carcereiro tem um relacionamento incomum e comovente com um preso que está no corredor na morte: Coffey, um negro enorme, condenado por ter matado brutalmente duas gêmeas de nove anos. Ele tem tamanho e força para matar qualquer um, mas seu comportamento é completamente oposto à sua aparência. Além de ser simples, ingênuo e ter pavor do escuro, ele possui um dom sobrenatural. Com o passar do tempo, o carcereiro aprende que, às vezes, os milagres acontecem nos lugares mais inesperados.', '1999', 1)");
        db.execSQL("INSERT INTO "+ DbOpenHelper.MOVIE_TABLE+" ('title_en', 'title_pt_br', 'category_id','comment', 'release_year', 'watched_where_id') VALUES ('The Man Who Knew Too Little', 'O Homem que Sabia de Menos', 2,'Wallace passa o aniversário com o irmão, que o leva a um espetáculo de representação interativo. Ele se envolve em plano de assassinato e, mesmo cercado de marginais, pensa que tudo é teatro. Os criminosos acham que ele é Spencer, um agente secreto.', '1997', 3)");
